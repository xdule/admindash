...
(function() {
    function u() {
        ...
        if (!0 !== p)
            return p;
        if (n)
            return CKEDITOR.dialog.validate.regex(n, q).call(this)
    }
    CKEDITOR.dialog.add("link", function(c) {
        ...
        return {
                ...
                elements: [{
                    ...
                    onChange: function() {
                        ...
                        for (f = 0; f < b.length; f++) {
                            ...
                            h && (h = h.getElement().getParent().getParent(),
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            onKeyUp: function() {
                                ...
                                a.setValue(f[0].toLowerCase())) : c.test(b) && a.setValue("");
                                this.allowOnChange = !0
                            },
                            onChange: function() {
                            ...
                            validate: function() {
                                var a = this.getDialog();
                                return a.getContentElement("info", "linkType") && "url" != a.getValueOf("info", "linkType") ? !0 : !c.config.linkJavaScriptLinksAllowed && /javascript\:/.test(this.getValue()) ? (alert(g.invalidValue),
            ...
            onOk: function() {
                ...
                if (this._.selectedElements.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        d = g[l];
                        d.collapsed ? (e = new CKEDITOR.dom.text(a.linkText || ("email" == a.type ? a.email.address : b.set["data-cke-saved-href"]),c.document),
                        d.insertNode(e),
                        d.selectNodeContents(e)) : q !== a.linkText && (e = new CKEDITOR.dom.text(a.linkText,c.document),
            ...
            onFocus: function() {
                ...
                a && "url" == a.getValue() && (a = this.getContentElement("info", "url"),
                a.select())
            }
        }
    })
