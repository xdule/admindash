function getCollapsibleItem() {
    var collapsibleItem =
        ...
        '           <a class="collapsed collapsible-item-title-link-icon " role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="glyphicon glyphicon-chevron-down">&nbsp;</span></a>' +
        ...
        editor.widgets.add('collapsibleItem', {
            ...
            editables: {
                ...
                content: {
                    ...
                    allowedContent: 'p;br;span(*)[*];ul;ol;li;strong;em;u;div;div[*];div(*)[*];table(*)[*];tbody;thead;tr;td;th;hr;a;a[*];a(*)[*];img(*)[*];iframe(*)[*];h4(*)[*];article(*)[*];img(*)[*]'
                }
            },
            allowedContent: 'div(!collapsible-item*,panel*,collapse,ses*)[*];h4(!collapsible-item*,panel*)[*];a(!collapsible-item*,collapsed,panel*)[*];span(!glyphicon*)[*];div[*];iframe(*)[*];',
