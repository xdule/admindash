        ...
        editor.widgets.add('accordionList', {
            ...
            editables: {
                content: {
                    ...
                    allowedContent: 'div(*)[*];a(*)[*];iframe(*)[*];h4(*)[*];a(!collapsible-item*,panel*,collapsed)[*];span(!glyphicon*)[*];p;br;span(*)[*];ul(*)[*];ol;li(*)[*];strong;em;u;table[*];tbody;theader;tr;td;th;hr;a;a(!href,*)[*];article(*)[*];img(*)[*]'
                }
            },
            allowedContent: 'div(*)[*];iframe(*)[*];h4(*)[*];', /*'div(!accordion-list*)[*];'*/
...
/*'div(!collapsible-item*,panel*,collapse,ses*)[*];h4(!collapsible-item*,panel*)[*];a(!collapsible-item*,panel*,collapsed)[*];span(!glyphicon*)[*];p;br;span[*];ul;ol;li;strong;em;u;table[*];tbody;theader;tr;td;th;hr;a;a(!href,*)[*];'*/